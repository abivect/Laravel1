...
<head>
  ...
  <title>PhotoFolio Bootstrap Template - Index @yield('content')</title>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="index.blade.php" class="logo d-flex align-items-center  me-auto me-lg-0">
        ...
        <img src="assets/img/gallery/gallery-3.jpg" alt="Deskripsi Ikon">
        <h1>Portofolio FARDAN</h1>
      </a>
      ...
      <div class="header-social-links">
        ...
        <a href="https://id.linkedin.com/" class="linkedin"><i class="bi bi-linkedin"></i></i></a>
      </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          <h2>I'm <span>Fardan Abi Ghozali</span> a Professional Artis Vector from malang</h2>
          <p>berikut adalah portofolio saya selama saya menjadi artis vector </p>
          <a href="contact.html" class="btn-get-started">providing vector services</a>
        </div>
      </div>
    </div>
  ...
  <footer id="footer" class="footer">
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://www.instagram.com/abi.vect/">Abivect</a>
      </div>
    </div>
  </footer><!-- End Footer -->
